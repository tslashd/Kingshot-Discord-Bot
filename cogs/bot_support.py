...
class SupportOperations(commands.Cog):
    ...
    async def show_about_menu(self, interaction: discord.Interaction):
        ...
        about_embed = discord.Embed(
            title=f"{theme.infoIcon} About Kingshot Project",
            description=(
                f"**Open Source Bot**\n"
                f"{theme.upperDivider}\n"
                f"This is an open source Discord bot for Kingshot.\n"
                f"The project is community-driven and freely available for everyone.\n\n"
                f"{theme.documentIcon} **Documentation:** [Wiki](https://github.com/kingshot-project/Kingshot-Discord-Bot/wiki)\n"
                f"{theme.linkIcon} **Repository:** [GitHub](https://github.com/kingshot-project/Kingshot-Discord-Bot)\n"
    ...
    async def show_support_info(self, interaction: discord.Interaction):
        support_embed = discord.Embed(
            ...
            description=(
                ...
                "**GitHub Repository:** [Kingshot Project](https://github.com/kingshot-project/Kingshot-Discord-Bot)\n"
                "**Issues & Bug Reports:** [GitHub Issues](https://github.com/kingshot-project/Kingshot-Discord-Bot/issues)\n\n"
