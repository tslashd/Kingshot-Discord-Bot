...
EVENT_TYPES = ["Swordland Showdown", "Tri-Alliance Clash", "Viking Vengeance", "Bear Trap", "Castle Battle", "Flamedragon Tyrant", "Other"]

EVENT_TYPE_ICONS = {
    "Swordland Showdown": "⚔️",
    "Tri-Alliance Clash": "🔱",
    "Viking Vengeance": "🔥",
    "Bear Trap": "🐻",
    "Castle Battle": "🏰",
...
_OCR_EVENT_DISPLAY = {
    "foundry_battle": ("Swordland Showdown", "⚔️"),
...
def event_type_display(event_type: str) -> tuple:
    ...
    ('foundry_battle') or a manual label ('Viking Vengeance')."""
...
LEGION_EVENT_TYPES = ["Swordland Showdown", "Tri-Alliance Clash"]
...
class EditEventDetailsView(discord.ui.View):
    def __init__(self, session_id, session_name, current_event_type, current_event_date, parent_view, is_edit=True, current_event_subtype=None):
        ...
        # Create legion dropdown only for legion events (Swordland Showdown, Tri-Alliance Clash)
        self.legion_select = None
