            ...
            if result:
                ...
                if admin_user:
                    ...
                    status_embed.add_field(
                        ...
                        value=(
                            f"**Documentation:** [Wiki](https://github.com/kingshot-project/Kingshot-Discord-Bot/wiki)\n"
                            f"**GitHub Repository:** [Kingshot Project](https://github.com/kingshot-project/Kingshot-Discord-Bot)\n"
                            f"**Discord Community:** [Join our Discord](https://discord.gg/apYByj6K2m)\n"
                            f"**Bug Reports:** [GitHub Issues](https://github.com/kingshot-project/Kingshot-Discord-Bot/issues)\n\n"
                    ...
                    status_embed.set_footer(text="Thanks for using the bot! Maintained with ❤️ by the Kingshot Project team.")
